...
@description('Target GitHub repository (owner/name) the orchestrator delegates issues to.')
    ...
    env: union(
      [
        ...
        { name: 'GITHUB_REPO', value: githubRepo }
        {
          ...
          value: foundryInsights.properties.ConnectionString
        }
        { name: 'OTEL_SERVICE_NAME', value: 'copilot-sdk-service' }
      ],
      useAzureModel ? [
...
module containerAppWeb 'br/public:avm/ptn/azd/acr-container-app:0.4.0' = {
  ...
  params: {
    ...
    containerMaxReplicas: 3
    env: [
      { name: 'API_URL', value: containerAppApi.outputs.uri }
    ]
  }
}
